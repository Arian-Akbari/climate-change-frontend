...
interface Tool {
  ...
  onClick: ({
    appendMessage,
  }: { appendMessage: UseChatHelpers['append'] }) => void;
}
...
const defaultTools: Tool[] = [
  {
    ...
    onClick: ({ appendMessage }) => {
      appendMessage({
        content: 'Could you summarize this for me?',
        role: 'user',
        id: nanoid(),
      });
    },
...
export const Toolbar = memo(PureToolbar, (prevProps: any, nextProps: any) => {
